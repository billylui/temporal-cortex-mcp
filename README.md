...
**v0.8.0** · March 2026 · [Changelog](CHANGELOG.md) · **Website:** [temporal-cortex.com](https://temporal-cortex.com)
...
curl -sL https://github.com/temporal-cortex/mcp/releases/download/mcp-v0.8.0/SHA256SUMS.txt
