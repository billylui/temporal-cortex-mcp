...
**v0.6.1** · March 2026 · [Changelog](CHANGELOG.md) · **Website:** [temporal-cortex.com](https://temporal-cortex.com)
...
```json
{
  "mcpServers": {
    "temporal-cortex": {
      "command": "npx",
      "args": ["-y", "@temporal-cortex/cortex-mcp@0.6.1"],
      "env": {
...
curl -sL https://github.com/temporal-cortex/mcp/releases/download/mcp-v0.6.1/SHA256SUMS.txt
...
```bash
# HTTP mode example
HTTP_PORT=8009 npx @temporal-cortex/cortex-mcp@0.6.1
```
