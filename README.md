...
**v0.5.5** · February 2026 · [Changelog](CHANGELOG.md) · **Website:** [temporal-cortex.com](https://temporal-cortex.com)
...
```json
{
  "mcpServers": {
    "temporal-cortex": {
      "command": "npx",
      "args": ["-y", "@temporal-cortex/cortex-mcp@0.5.5"],
      "env": {
...
```bash
# HTTP mode example
HTTP_PORT=8009 npx @temporal-cortex/cortex-mcp@0.5.5
```
