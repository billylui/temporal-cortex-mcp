...
- **What changed:** Created a 4th public repository ([temporal-cortex-skill](https://github.com/billylui/temporal-cortex-skill)) containing the `calendar-scheduling` Agent Skill. The skill teaches AI agents the 4-step scheduling workflow (orient → resolve → query → book) using the MCP server's 11 tools.
